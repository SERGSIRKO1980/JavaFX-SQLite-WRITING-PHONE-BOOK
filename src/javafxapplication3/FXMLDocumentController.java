...
table_students();
  System.out.println("\nYou clicked Update");
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       database.create_or_connection();      //    проверка наличия базы и ее создание если нет
          table_students();                                     //     отображение записей базы в Tablevew
          database.select_database();             //    отображение записей базы в консоли
 }
    //==================    отображение базы в Tablevew    =============================
    void table_students(){
     try{
...
//=================   преобразование выделенной строки   ==============
